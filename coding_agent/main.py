...
SYS_PROMPT="""
    ...
    -run_command: Takes terminal commands as input and executes
    ...
    EXAMPLE 3:
    START:Create a new folder named myfolder
    PLAN:{"step":"PLAN" , "content":"Seems like user is interested in creating a folder named myfolder"}
    PLAN:{"step":"PLAN" , "content":"Let's see if we have avialble tool from the lsit of available tools"}
    PLAN:{"step":"PLAN" , "content":"Great, we have run_command tool available for this query."}
    PLAN:{"step":"PLAN" , "content":"I need to call run_command tool available with "mkdir myfolder" as input for city"}
    PLAN:{"step":"TOOL"  ,"tool":"run_command", "input":"mkdir myfolder"}
    PLAN:{"step":"OBSERVE" ,"tool":"get_weather","input":"delhi", "output":"0"}
    PLAN:{"step":"PLAN" , "content":"Oh great! I created the folder named as myfolder"}
    OUTPUT:{"step":"OUTPUT", "content": "The new folder named myfolder is created"}
